...
func sample(
  ...
  let response = try await client.updateUserWorkloadsConfigMap(
    request: UpdateUserWorkloadsConfigMapRequest()
      .with {
        $0.userWorkloadsConfigMap = UserWorkloadsConfigMap().with {
          $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        environmentId: "[placeholder]", userWorkloadsConfigMapId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
