...
extension Clients {
  final class ImageVersionsLogging: ImageVersionsStub {
    let inner: any ImageVersionsStub
    let logger: Logger

    public init(_ inner: any ImageVersionsStub, logger: Logger) {
      var logger = logger
      ...
      logger[metadataKey: "gcp.experimental.swift.client"] = "ImageVersions"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func listImageVersions(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ListImageVersionsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudOrchestrationAirflowServiceV1.ListImageVersionsResponse
          in
          return try await self.inner.listImageVersions(request: r, options: o)
        })
    }
