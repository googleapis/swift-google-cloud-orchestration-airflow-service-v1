...
extension Clients {
  class ImageVersionsTransport: ImageVersionsStub {
    ...
    public func listImageVersions(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/imageVersions"
      }()
      var query = [
      ...
      query.append(
        contentsOf: try encoder.encode(request.includePastReleases, prefix: "includePastReleases"))
