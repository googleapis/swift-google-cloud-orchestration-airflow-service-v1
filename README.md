...
Add `swift-google-cloud-orchestration-airflow-service-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-orchestration-airflow-service-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudOrchestrationAirflowServiceV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudOrchestrationAirflowServiceV1 <target-name> --package swift-google-cloud-orchestration-airflow-service-v1
```
